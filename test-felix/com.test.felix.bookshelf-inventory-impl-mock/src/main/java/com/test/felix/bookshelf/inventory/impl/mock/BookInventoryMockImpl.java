...
public class BookInventoryMockImpl implements BookInventory{
	...
	@Override public MutableBook createBook( String isbn ) throws BookAlreadyExistsException{
		return new MutableBookImpl(isbn);
	}

	@Override public MutableBook loadBookForEdit( String isbn ) throws BookNotFoundException{
	...
	@Override public String storeBook( MutableBook book ) throws InvalidBookException{
	...
	@Override public Book loadBook( String isbn ) throws BookNotFoundException{
		return loadBookForEdit( isbn );
	}

	@Override public void removeBook( String isbn ) throws BookNotFoundException{
	...
	@Override public Set<String> searchBooks( Map<SearchCriteria, String> criteria ){
